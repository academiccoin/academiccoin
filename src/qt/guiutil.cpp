...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "academiccoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("academiccoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("academiccoin-Qt"));
